...
<?
		...
		echo BeginNote('style="position: relative; top: -15px;"');
		?><span class="required">Ахтунг! Данный битрикс взломан к хуям, и ОЧЕНЬ НЕ РЕКОМЕНДУЕТСЯ использовать систему обновления битрикса, а то вас посадят в тюрьму!!!</span><?
		echo EndNote();
